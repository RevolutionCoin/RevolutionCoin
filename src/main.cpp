...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // RevolutionCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "RevolutionCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 60;	// RevolutionCoin: 2 min
static const int64 nTargetSpacing = 120;						// RevolutionCoin: 2 min
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
static const int64 nTargetTimespanRe = 2 * 60; // 2 min
static const int64 nTargetSpacingRe = 120; // RevolutionCoin: 2 min
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal RevolutionCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RevolutionCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // RevolutionCoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // RevolutionCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
